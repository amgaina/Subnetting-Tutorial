 ...
 */
function generateIP() {
  ip[0] = Math.floor(Math.random() * (191 - 128 + 1)) + 128;
...
function next0() {
  ...
  check(default_sub, "B", feedback_mssg0);
  id_1.style.display = default_sub === "B" ? "block" : "none";
}
...
function next3() {
  ...
  let value = ip[0] + "." + ip[1] + "." + last + ".255";

  if (last >= 256) {
    last = 255;
    value = ip[0] + "." + ip[1] + "." + "255.255";
  }
